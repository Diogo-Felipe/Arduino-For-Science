//Programa: Detector de Voltagem Para Três Detectores
//Descrição: Detecção semi-manual de voltagem para três detectores (Solução Simplificada)
...
void setup() {
  ...
  Serial.println("Medida Voltagem_1 Voltagem_2 Voltagem_3"); //Primeira linha do programa
}
...
void loop() {
    ...
    if(digitalRead(botao) == HIGH){
        ...
        voltagem3 = medeVoltagem(detector3);
               
        //Impressão na tela dos valores separados por alguns espaços
        Serial.print(medida); //'Eixo x' ou 'id' da medida
        Serial.print("        ");
        Serial.print(voltagem3); //Valor da medida do primeiro detectot ('eixo yA')
        Serial.print("        ");
        Serial.println(voltagem3); //Valor da medida do primeiro detectot ('eixo yB')
        Serial.print("        ");
        Serial.println(voltagem3); //Valor da medida do primeiro detectot ('eixo yC')
